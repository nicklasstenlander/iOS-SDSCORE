...
extension Color {
    ...
    static let sdsBackground = Color.adaptive(light: "f5f8f6", dark: "141a16")
    static let sdsCard = Color.adaptive(light: "ffffff", dark: "1c1c1c")
    ...
    static let sdsPinkSurface = Color.adaptive(light: "fae8ef", dark: "2a1519")
    static let sdsVioletSurface = Color(hex: "f0e7f4")
    static let sdsSkySurface = Color(hex: "e2f0f4")
    static let sdsAmberSurface = Color.adaptive(light: "f8edc0", dark: "2a2517")
    static let sdsWarningText = Color.adaptive(light: "6b4f00", dark: "e8bb5a")
